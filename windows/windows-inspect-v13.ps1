# ============================================================
# Windows Inspection Script v13 (Pure PowerShell, fully offline)
...
$outDir = 'C:\Users\Pengfei\AppData\Roaming\TRAE SOLO CN\ModularData\ai-agent\work-mode-projects\6a815fefd99071de7cd4052b'
